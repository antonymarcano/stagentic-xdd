...
- **Guarded by:** *Transcript shows the failing test was written before the production code*
- **Config(s) seen in:**
...
This lesson's misstep recurred on 2026-07-12 under the same recorded config — see
the [recurrence lesson](../20260712-1855-write-the-failing-test-before-the-production-code-RECURRED/lesson.md).

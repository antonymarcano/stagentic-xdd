...
class TestArchive:
    def test_should_copy_the_workspace_to_a_timestamped_folder(self, workspace, artefacts_dir):
    ...
    def test_should_exclude_transient_dirs(self, workspace, artefacts_dir, transient):
    ...
    def test_should_return_the_destination_it_wrote(self, workspace, artefacts_dir):
        dest = archive(tmp_path=workspace, test_name="test_foo",
                       artefacts_dir=str(artefacts_dir), timestamp="20260527-101638")
    ...
    def test_should_use_a_short_uuid_suffix(self, workspace, artefacts_dir):
        dest = archive(tmp_path=workspace, test_name="test_foo",
                       artefacts_dir=str(artefacts_dir), timestamp="20260527-101638")
    ...
    def test_should_not_collide_for_the_same_timestamp_and_test_name(self, tmp_path, artefacts_dir):
